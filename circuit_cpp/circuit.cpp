...
#include "circom.hpp"
#include "calcwit.hpp"
void MerkleTree_0_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MerkleTree_0_run(uint ctx_index,Circom_CalcWit* ctx);
...
MerkleTree_0_create(1,0,ctx,"main",0);
MerkleTree_0_run(0,ctx);
}
